...
{
    private CityRepositoryInterface $cityRepository; // interface = repository
    private CategoryRepositoryInterface $categoryRepository; // interface = repository
    private BoardingHouseRepositoryInterface $boardingHouseRepository; // interface = repository
